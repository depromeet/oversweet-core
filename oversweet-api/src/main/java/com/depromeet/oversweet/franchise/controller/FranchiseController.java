...
public class FranchiseController {
    ...
    public ResponseEntity<DataResponse<MostPopularDrinkResponse>> getPopularDrinksByFranchiseId(
            @PathVariable @Parameter(description = "프랜차이즈 검색을 위한 키워드") final Long franchiseId,
